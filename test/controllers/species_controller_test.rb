...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post species_index_url, params: { species: { name: @species.name, population: @species.population } }, as: :json
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { name: @species.name, population: @species.population } }, as: :json
    assert_response 200
  end
